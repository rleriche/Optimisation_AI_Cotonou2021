...
$\mathcal S$ is an hypercube of $\Rset[d]$ described by the constraints
\wip \\
\mbox{
\begin{minipage}[c]{0.4\textwidth}
If $x^i$ is at a bound and the search direction $d^i$ takes it outside $\mathcal S = [LB,UB]$, 
